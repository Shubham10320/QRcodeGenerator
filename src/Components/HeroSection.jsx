  ...
  return (
    <Box w={{base:"100%",sm:"100%",md:"100%", lg:"90%",xl:'90%'}} p="20px" m="auto" display="flex">
        <Flex flexDirection={{base:"column", sm:"column", md:'column', lg:'row', xl:'row'}} gap="10px" >
            <Box w={{lg:"50%",xl:'50%'}}>
                <Heading as='h1' fontSize={{base:'35px', sm:'40px', md:'45px', lg:'50px', xl:'50px'}} fontWeight="extrabold">Create custom QR codes for free with our generator.</Heading>
                ...
                <Button mt={{base:"10px", sm:"12px", md:'15px', lg:"20px", xl:"60px"}} background="teal" color="white" p="25px" borderRadius="30px" _hover={{background:'lightgreen', color:'black'}}>Create your QR code now</Button>
            </Box>
